...
public class Test2 {
    public static void main(String[] args){
        ...
        ArrayList<String> familyNameTempList = (ArrayList<String>) ReUtil.findAll("([\\u4E00-\\u9FA5]{4})，([\\u4E00-\\u9FA5]{4})。", familyNameStr, 1);
        ...
        FileUtil.writeLines(list,"E:\\java代码\\xiangmu\\src\\day29\\a.txt","UTF-8");
